...
if __name__ == "__main__":
    ...
    print("N", N)
    print("E", E)
    notification_manager = Notification_Manager(background="white", corner=S+W)
    ...
    create_notification(500, "You've been working on 'AI Assignment 4' for 2 hours! Take a break fam.")
    ...
    # notification_manager.warning("You've been working on 'AI Assignment 4' for 2 hours! Take a break fam.")
